...
class ImprovedMLPredictor:
    def __init__(self, model_path: str = "models/trained_models/improved_model.pkl"):
    ...
    def load_model(self) -> bool:
        ...
        try:
            if os.path.exists(self.model_path):
                ...
                self.logger.info(f"Improved model loaded from {self.model_path}")
                
                # Load feature info
                info_path = "models/trained_models/model_info.pkl"
    ...
    def predict_signal(self, market_data: pd.DataFrame) -> Dict:
        """Predict signal with improved method"""
        try:
            ...
            self.logger.error(f"Error in improved prediction: {e}")
            return {"error": str(e)}
